...
var Indiro = function () {
    ...
    var dzTheme = function () {
        'use strict';
        var loadingImage = '<img src="a/images/loading.gif">';
    ...
    var handleSidebarMenu = function () {
        jQuery('.menu-btn').on('click', function () {
            ...
            if ($(this).hasClass('open')) {
                jQuery('.logo-header.logo-white img').attr('src', 'a/images/logo.png');
            } else {
                jQuery('.logo-header.logo-white img').attr('src', 'a/images/logo-white.png');
            }
        ...
        jQuery('.header.style-2 .menu-btn').on('click', function () {
            ...
            //for nav hidden
            if ($(this).hasClass('open')) {
                jQuery('.header.style-2 .header-nav').css({
                    "visibility": "hidden",
                    "opacity": "0"
                });
            } else {
        ...
        jQuery(window).on('scroll', function () {
            if (jQuery('.sticky-header').length > 0) {
                ...
                if ($(window).scrollTop() > menu.offset().top) {
                    ...
                    $('.site-header .container > .logo-header .logo').attr('src', 'a/images/logo.png');
                    $('.site-header .container > .logo-header .logo-2').attr('src', 'a/images/logo-2.png');
                    $('.site-header .container > .logo-header .logo-3').attr('src', 'a/images/logo-3.png');
                } else {
                    menu.removeClass('is-fixed');
                    $('.site-header .container > .logo-header .logo, .site-header .container > .logo-header .logo-2, .site-header .container > .logo-header .logo-3').attr('src', 'a/images/logo-white.png')
                }
            }
        });
