                ...
                <div class="dz-bnr-inr-entry">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Client APS</li>
                        </ul>
                    </nav>
                    <!-- Breadcrumb Row End -->
                </div>
        ...
        <section class="content-inner">
			<div class="container">
                ...
                <div class="section-head style-1 text-center aos-item aos-init aos-animate" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
					<h6 class="sub-title text-primary">Our Clients</h6>
					<h2 class="title m-b20"> Cient APS</h2>
				</div>
				<div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
						<div class="dz-team style-1 text-center m-b30">
							<div class="dz-media">
								<img src="{{asset('gambar/clientlist') .'/' . $item->gambar}}" alt="">
							</div>
