...
@section('body')
    <div class="page-content bg-white">
        ...
        <div class="dz-bnr-inr dz-bnr-inr-sm my-paroller overlay-black-middle text-center" id="my-element"
            ...
            style="background-image: url({{ asset('gambar/sertifikasi/') . '/' . $data->image }});">
            <div class="container">
                <div class="dz-bnr-inr-entry">
                    ...
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('/') }}">Sertifikasi Kompetensi</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-8 m-b40">
                                ...
                                <ul class="nav nav-tabs style-1 m-b30">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="javascript:void(0);" data-bs-toggle="tab"
                                            data-bs-target="#oneTab2">Paket Sertifikasi Kompetensi</a>
                                    </li>
                        ...
                        <h2 class="dz-title"> sertifikasi Terkait
                        </h2>
                        <br>
                        <ul id="masonry" class="row blog-masonry" style="position: relative; ">
                            ...
                            <div class="dz-card style-1 shadow m-b30">
                                <div class="dz-media">
                                    <a href="{{url('sertifikasi') . '/' . $item->slug}}">
                                        @if ($data->image == null)
                                        <img src="{{asset('gambar/sertifikasi') .'/' . 'none.jpg'}}"
                                        alt="">
                                        @else
                                ...
                                <div class="dz-info">
                                    ...
                                    <h4 class="dz-title"><a href="{{url('sertifikasi') . '/' . $item->slug}}">{{$item->judul}}</a></h4>
                                    <p>{{$item->keterangan}}</p>
                                </div>
                            </div>
                        </li>
                        ...
                        <aside class="side-bar sticky-top right">
                            <div class="widget style-1">
                                <div class="widget-title">
                                    <h4 class="title">Informasi sertifikasi</h4>
                                </div>
                                @if ($data->image == null)
                                    <img style="width: 100%" src="{{ asset('gambar/sertifikasi/') . '/' . 'none.jpg' }}"
                                        alt="">
                                @else
                                    <img style="width: 100%" src="{{ asset('gambar/sertifikasi/') . '/' . $data->image }}"
                                        alt="">
                                @endif
                            ...
                            <div class="widget style-1">
                                ...
                                <div class="search-bx">
                                    <form action="{{url('sertifikasi')}}" role="search">
