        ...
        <div class="dz-bnr-inr dz-bnr-inr-sm overlay-black-middle text-center"
            ...
            <div class="container">
                <div class="dz-bnr-inr-entry">
                    <h1>Tenaga Ahli APS</h1>
                    <!-- Breadcrumb Row -->
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">

                            <li class="breadcrumb-item"><a href="{{ url('/') }}">Profil</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Tenaga Ahli APS</li>
                        </ul>
                    </nav>
                    <!-- Breadcrumb Row End -->
                </div>
        ...
        <section class="content-inner">
			<div class="container">
                <div class="section-head style-1 text-center aos-item aos-init aos-animate" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
					...
					<h2 class="title m-b20">Instruktur &amp; Tenaga Ahli</h2>
				</div>
                <br>
				<div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
						<div class="dz-team style-1 text-center m-b30">
							<div class="dz-media">
								<img src="{{asset('gambar/ins') .'/' . $item->gambar}}" alt="">
							</div>
							<div class="dz-content">
								<h4 class="dz-name">{{$item->nama}}</h4>
                ...
                <p>* Semua trainer/tenaga ahli telah memiliki sertifikat kompetensi 
                    dibidangnya masing-masing dari Badan Nasional Sertifikasi Profesi 
                    (BNSP) atau lembaga otoritas kompeten lainnya</p>
			</div>
		</section>
