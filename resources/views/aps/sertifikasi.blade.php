        ...
        <div class="dz-bnr-inr dz-bnr-inr-sm overlay-black-middle text-center"
            ...
            <div class="container">
                <div class="dz-bnr-inr-entry">
                    <h1>Sertifikasi Kompetensi</h1>
                    <!-- Breadcrumb Row -->
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">

                            <li class="breadcrumb-item"><a href="{{ url('/') }}">Beranda</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Sertifikasi Kompetensi</li>
                        </ul>
                    </nav>
                    <!-- Breadcrumb Row End -->
                </div>
                            ...
                            <div class="ft-row m-b0">
                                <form action="">
                                    <div class="input-group">
                                        <input name="cari" required="required" type="text" placeholder="sertifikasi"
                        ...
                        @foreach ($berita as $b)
                            <li class="card-container grid-item col-xl-4 col-md-6">
                                <div class="dz-card style-1 shadow m-b30">
                                    <div class="dz-media">
                                        <a href="{{ url('sertifikasi/') . '/' . $b->slug }}">
                                            @if ($b->image == null)
                                            <img
                                            src="{{ asset('gambar/sertifikasi/') . '/' . 'konsul.png' }}"
                                            alt="">
                                                @else
                                                <img
                                                src="{{ asset('gambar/sertifikasi/') . '/' . $b->image }}"
                                                alt="">
                                            @endif
                                         </a>
                                    </div>
...
\
                                        ...
                                        <h4 class="dz-title"><a
                                                href="{{ url('sertifikasi/') . '/' . $b->slug }}">{{ $b->judul }}</a></h4>
                                            <p>{{$b->keterangan}}</p>
                                    </div>
                                </div>
                            </li>
