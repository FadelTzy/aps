        ...
        <div class="dz-bnr-inr dz-bnr-inr-sm overlay-black-middle text-center"
            ...
            <div class="container">
                <div class="dz-bnr-inr-entry">
                    <h1>Landasan Hukum APS</h1>
                    <!-- Breadcrumb Row -->
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">

                            <li class="breadcrumb-item"><a href="{{ url('/') }}">Profil</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Landasan Hukum APS</li>
                        </ul>
                    </nav>
                    <!-- Breadcrumb Row End -->
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12 inner-text">
                        <h2 class="title">Landasan Hukum</h2>
                    {!!$data->landasan_hukun!!}
                    </div>
                    <div class="col-lg-4 col-md-5 col-sm-12 m-b30">
                        <aside class="side-bar sticky-top right">
                            ...
                            <div class="service_menu_nav widget style-1">
                                <ul class="menu">
                                    <li class="menu-item "><a href="{{url('profil')}}">Profill APS</a></li>
                                    <li class="menu-item"><a href="{{url('visi-misi')}}">Visi & Misi</a></li>
                                    <li class="menu-item active"><a href="{{url('landasan-hukum')}}">Landasan Hukum</a></li>
