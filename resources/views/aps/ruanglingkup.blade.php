        ...
        <div class="dz-bnr-inr dz-bnr-inr-sm overlay-black-middle text-center"
            ...
            <div class="container">
                <div class="dz-bnr-inr-entry">
                    <h1>Ruang Lingkup APS</h1>
                    <!-- Breadcrumb Row -->
                    <nav aria-label="breadcrumb" class="breadcrumb-row">
                        <ul class="breadcrumb">

                            <li class="breadcrumb-item"><a href="{{ url('/') }}">Profil</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Ruang Lingkup APS</li>
                        </ul>
                    </nav>
                    <!-- Breadcrumb Row End -->
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-sm-12 inner-text">
                        <h2 class="title">Ruang Lingkup</h2>
                    {!!$data->ruang_lingkup!!}
                    </div>
                        ...
                        <aside class="side-bar sticky-top right">
                            ...
                            <div class="service_menu_nav widget style-1">
                                <ul class="menu">
                                    ...
                                    <li class="menu-item active"><a href="{{url('ruang-lingkup')}}">Ruang Lingkup</a></li>
