                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="tekstuj" id="tempatsinggah3">
                                <input type="hidden" name="teksmate" id="tempatsinggah4">
                                ...
                                <label>Tujuan</label>
                                <div class="input-group">
                                    <textarea id="ckeditor2" name="tujuan" class="form-control" rows="10">{{ $data->tujuan }} </textarea> <span class="input-group-addon"><i
                                            class=" fa fa-check"></i></span>
                                </div><!-- input-group -->
                                <br>
                                <label>Materi</label>
                                <div class="input-group">
                                    <textarea id="ckeditor3" name="materi" class="form-control" rows="10">{{ $data->materi }} </textarea> <span class="input-group-addon"><i
                                            class=" fa fa-check"></i></span>
                                </div><!-- input-group -->
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4" style="margin-top: 20px">
                        ...
                        <div class="input-group" style="width: 100%">
                            <input type="number" value="{{$data->harga}}" name="harga" id="harga" class="form-control">
                        ...
                        <div class="input-group" style="width: 100%">
                            <input type="text" value="{{$data->instruktur}}" name="ins" placeholder="input Instruktur" id="ins" class="form-control">
...
@push('staffjs')
    ...
    <script>
        ...
        CKEDITOR.instances['ckeditor2'].setData(`{!! $data->tujuan !!}`);
        CKEDITOR.instances['ckeditor3'].setData(`{!! $data->materi !!}`);
        ...
        $("#tambahdata").on('submit', function(id) {
            ...
            $.LoadingOverlay("show");
            $.ajax({
                url: '{{ url('admin/pelatihan/edit') . '/' . $data->id }}',
        ...
        function deleteimage(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/pelatihan/gambar',
                    type: "POST",
                    data: {
                        id: id[0],
                        file: id[1]
