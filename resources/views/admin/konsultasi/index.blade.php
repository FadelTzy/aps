        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Informasi Konsultasi</a></li>

                </ul>
                <h4>Manajemen Informasi Konsultasi</h4>
            </div>
        </div><!-- media -->
    </div><!-- pageheader -->
@endsection
    ...
    <div class="contentpanel">
        <div class="panel panel-primary-head">
            <div class="panel-heading row" style="margin-bottom: 10px;">
                <div class="col-xs-6">
                    <h4 class="panel-title">Konsultasi</h4>
                    <p>Manajemen pengelolaan data Konsultasi.</p>
                </div>
                <div class="col-xs-6 text-right">
                    <a class="btn btn-info" type="button" href="{{ route('konsultasi.create') }}"><i
                            class=" fa fa-plus"></i>
                        Tambah Data</a>
                </div>
            </div><!-- panel-heading -->
