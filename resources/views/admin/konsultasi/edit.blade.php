    ...
    <div class="contentpanel">
        <div class="panel panel-primary-head">
            ...
            <div class="panel-heading row" style="margin-bottom: 10px;">
                <div class="col-xs-6">
                    <a href="{{ route('konsultasi.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i>
                        Kembali</a>
                </div>
...
@push('staffjs')
    ...
    <script>
        ...
        $("#tambahdata").on('submit', function(id) {
            ...
            $.LoadingOverlay("show");
            $.ajax({
                url: '{{ url('admin/konsultasi/edit') . '/' . $data->id }}',
        ...
        function deleteimage(id) {
            ...
            if (data) {
                ...
                $.ajax({
                    url: url + '/admin/konsultasi/gambar',
                    type: "POST",
                    data: {
                        id: id[0],
                        file: id[1]
