    ...
    <div class="contentpanel">
        <div class="panel panel-primary-head">
            <div class="panel-heading row" style="margin-bottom: 10px;">
                <div class="col-xs-6">
                    <h4 class="panel-title">Instruktur</h4>
                    <p>Manajemen pengelolaan data Instruktur.</p>
                </div>
    ...
    <div class="modal fade" id="myModalu" tabindex="-1" role="dialog" aria-labelledby="myModalLabelu" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabelu">Edit instruktur</h4>
                </div>
                <div class="modal-body">
                    <div class="panel-body nopadding">
                        ...
                        <form id="upddata" class="form-horizontal form-bordered">
                            ...
                            <label>Nama instruktur</label>
                            <div class="input-group">
                                <input type="text" id="namau" name="nama" placeholder="Input "
                                    class="form-control" />
                                <span class="input-group-addon"><i class=" fa fa-check"></i></span>
                            </div><!-- input-group -->
                            <br>
                            <label>Jabatan</label>
                            <div class="input-group">
                                <input type="text" id="jabatanu" name="jabatan" placeholder="Input Jabatan"
                                    class="form-control" />
                                <span class="input-group-addon"><i class=" fa fa-check"></i></span>
                            </div><!-- input-group -->
                            <br>
...
@push('staffjs')
    ...
    <script>
        ...
        function staffupd(id) {
            $('#myModalu').modal('show');
            $("#idu").val(id.id);
            $("#namau").val(id.nama);            $("#jabatanu").val(id.jabatan);
