        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Sertifikasi Kompetensi</a></li>
                    <li><a href="#">Create</a></li>
                </ul>
                <h4>Manajemen Sertifikasi Kompetensi</h4>
            </div>
        </div><!-- media -->
    </div><!-- pageheader -->
@endsection
            ...
            <form id="tambahdata" class=" form-horizontal form-bordered">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label>Judul Sertifikasi Kompetensi</label>
                                ...
                                <br>
                                <label>Deskripsi Sertifikasi Kompetensi</label>
                                <div class="input-group">
                                    <textarea id="ckeditor" name="deskripsi" class="form-control ceki" rows="10"></textarea> <span class="input-group-addon"><i
                                            class=" fa fa-check"></i></span>
                                </div><!-- input-group -->
                                <br>
                                <label>Manfaat Sertifikasi Kompetensi</label>
                                <div class="input-group">
                                    <textarea id="ckeditor2" name="manfaat" class="form-control ceki" rows="10"></textarea> <span class="input-group-addon"><i
                                            class=" fa fa-check"></i></span>
                                </div><!-- input-group -->
                                <br>
                                <label>Paket Sertifikasi Kompetensi</label>
                                <div class="input-group">
                                    <textarea id="ckeditor3" name="paket" class="form-control ceki" rows="10"></textarea> <span class="input-group-addon"><i
                                            class=" fa fa-check"></i></span>
                                </div><!-- input-group -->
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4" style="margin-top: 20px">
                        <label>Gambar sertifikasi</label>
