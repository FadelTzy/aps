        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Informasi Sertifikasi Kompetensi</a></li>

                </ul>
                <h4>Manajemen Informasi Sertifikasi Kompetensi</h4>
            </div>
        </div><!-- media -->
    </div><!-- pageheader -->
@endsection
    ...
    <div class="contentpanel">
        <div class="panel panel-primary-head">
            <div class="panel-heading row" style="margin-bottom: 10px;">
                <div class="col-xs-6">
                    <h4 class="panel-title">Sertifikasi Kompetensi</h4>
                    <p>Manajemen pengelolaan data sertifikasi.</p>
                </div>
                <div class="col-xs-6 text-right">
                    <a class="btn btn-info" type="button" href="{{ route('sertifikasi.create') }}"><i
                            class=" fa fa-plus"></i>
                        Tambah Data</a>
                </div>
            </div><!-- panel-heading -->
