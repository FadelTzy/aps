    ...
    <div class="pageheader">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <h4>Manajemen Testimoni Client</h4>
            </div>
        </div><!-- media -->
    </div><!-- pageheader -->
@endsection
    ...
    <div class="contentpanel">
        <div class="panel panel-primary-head">
            <div class="panel-heading row" style="margin-bottom: 10px;">
                <div class="col-xs-6">
                    <h4 class="panel-title">Testimoni Client</h4>
                    <p>Manajemen pengelolaan data Testimoni Client</p>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="nama" placeholder="Input Lokasi" class="form-control" />
                                    ...
                                    <label>Pesan</label>
                                    <div class="input-group">
                                        <textarea class="form-control" placeholder="" name="pesan" id="" cols="30"
                                            rows="6"></textarea>
                        ...
                        <form id="upddata" class="form-horizontal form-bordered">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    ...
                                    <label>Pesan</label>
                                    <div class="input-group">
                                        <textarea class="form-control" placeholder="" name="pesan" id="pesanu"
...
@push('staffjs')
    ...
    <script>
        ...
        function staffupd(id) {
            ...
            $("#idu").val(id.id);
            $("#namau").val(id.nama);
            $("#pesanu").html(id.pesan);
            if (id.gambar != null) {
                var html = `<img src="${url + '/gambar/client/' + id.gambar}"
