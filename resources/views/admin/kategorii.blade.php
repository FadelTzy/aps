        ...
        <div class="media">
            ...
            <div class="media-body">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Kategori Konsultasi</a></li>
                </ul>
                <h4>Manajemen Kategori Konsultasi</h4>
            </div>
        </div><!-- media -->
    </div><!-- pageheader -->
@endsection
    ...
    <div class="contentpanel">
        <div class="panel panel-primary-head">
            <div class="panel-heading row" style="margin-bottom: 10px;">
                <div class="col-xs-6">
                    <h4 class="panel-title">Kategori Konsultasi</h4>
                    <p>Manajemen pengelolaan data Kategori Konsultasi.</p>
                </div>
